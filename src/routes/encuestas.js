...
root.get('/getEncuesta/:idABuscar', async (req, res) => {
    ...
    if (consulta.rows.length > 0) {
        ...
        res.status(500).json('Encuesta sin secciones');
    }
});
